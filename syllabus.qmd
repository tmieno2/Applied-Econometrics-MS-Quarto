...
# Deadlines below are printed from course-dates.json -- do not hardcode dates
# here, or they will drift out of step with the course calendar.
...
All meeting dates, holidays, and deadlines are laid out on the [course calendar](schedule.qmd).

## Office Hours:
Wednesday, 10:00 to 11:30 am or by appointment
...
+ **Final Paper**: 
  + For this assignment, you are asked to write a method-focused paper on the topic your of choice using a real world data set. You are encouraged to use the datasets you are using for your Master's thesis (talk with your advisor). Otherwise, you must find and use a <span style = "color: blue;"> panel </span> data set. The final paper is due <span style = "color: red;">`r format_course_date('final-paper', '%b %e (%a), %Y')`</span>. 
...
+ You also write a small paper proposal for your final paper (<span style = "color: red;">due: `r format_course_date('paper-proposal', '%b %e (%a), %Y')`</span>). This assignment is for keeping you on track for making timely progress on your final paper. Before you write a proposal, you will need to consult with me for your research topic and datasets to be approved (<span style = "color: red;">due: `r format_course_date('paper-topic-approval', '%b %e (%a), %Y')`</span>). This ensures that your final paper is feasible and avoid last-minute panic. 
