...
strip_answers <- function(file) {
  ...
  if (!is.null(qmd_instruction)) {
    qmd_out <- c(qmd_instruction, qmd_no_rchunks[-remove_lines])
  } else {
    qmd_out <- qmd_no_rchunks
  }

  qmd_final <- strip_span(qmd_out)

  return(qmd_final)
}

strip_span <- function(qmd) {
...
```{r}
#* knit the solution
rmarkdown::render(here::here("assignments/instructor/assignment-1/assignment-1-gen.qmd"))

#* create the student version
writeLines(
  strip_answers(file = here::here("assignments/instructor/assignment-1/assignment-1-gen.qmd")),
  here::here("assignments/students/assignment-1/assignment-1-student.qmd")
)
```
...
```{r}
#* knit the solution
rmarkdown::render(here::here("assignments/instructor/assignment-2/assignment-2-gen.qmd"))

#* create the student version
writeLines(
  strip_answers(file = here::here("assignments/instructor/assignment-2/assignment-2-gen.qmd")),
  here::here("assignments/students/assignment-2/assignment-2-student.qmd")
)
```
