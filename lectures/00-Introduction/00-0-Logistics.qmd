...
```{r}
#| include: false
# Dates below come from course-dates.json -- never hardcode one here.
...
+ <span style = "color: red;"> Teaching Assistant </span>: 
  - Mona Mosavi (E-mail: mmousavi2@huskers.unl.edu)
...
**Recommended:** 
Wooldridge, Jeffrey M. 2013. *Introductory Econometrics: A Modern Approach* (<span style = "color: red;">5</span>th edition). Mason, OH: South-Western Cengage Learning.
...
All dates, holidays, and deadlines: [course calendar](https://tmieno2.github.io/Applied-Econometrics-MS-Quarto/schedule.html)

## Grading

+ Problem sets (3 assignments): 30% 
+ Small-size midterms (2): 30%
+ Paper: 40%
...
**Use Quarto to write and submit your problem sets**
...
+ Midterm 1: `r format_course_date('midterm-1', '%b %e (%a), %Y')`
+ Midterm 2: `r format_course_date('midterm-2', '%b %e (%a), %Y')`
...
+ <span style = "color: red;"> `r format_course_date('paper-topic-approval', '%b %e (%a)')` </span>: identify a research topic and the data set you will be using, and get approval from the instructor
+ <span style = "color: red;"> `r format_course_date('paper-proposal', '%b %e (%a)')` </span>: paper proposal 
+ <span style = "color: red;"> `r format_course_date('final-paper', '%b %e (%a)')` </span>: final paper 
...
+ explanatory variables (the variables used to explain it)
