...
(Or, when $x$ increases by $1$ (100%), $y$ increases by $\beta_1$.)
...
+ Their goal is not predicting the demand of eco-labled apple. Understanding the <span style = "color: blue;"> causal </span> impact of price on demand.
+ The goal is achieved via randomization of the price variables at the stage of desiging the survey!
